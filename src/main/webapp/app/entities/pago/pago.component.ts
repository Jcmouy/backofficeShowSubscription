...
export class PagoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pagoService
      ...
      .subscribe(
        (res: HttpResponse<IPago[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPagos(): void {
    this.eventSubscriber = this.eventManager.subscribe('pagoListModification', () => this.loadPage());
  }
