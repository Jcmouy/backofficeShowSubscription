...
export class ContenidoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contenidoService
      ...
      .subscribe(
        (res: HttpResponse<IContenido[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IContenido[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
