...
export class ObraComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.obraService
      ...
      .subscribe(
        (res: HttpResponse<IObra[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInObras(): void {
    this.eventSubscriber = this.eventManager.subscribe('obraListModification', () => this.loadPage());
  }
