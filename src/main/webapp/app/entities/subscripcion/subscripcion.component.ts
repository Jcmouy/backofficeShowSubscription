...
export class SubscripcionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.subscripcionService
      ...
      .subscribe(
        (res: HttpResponse<ISubscripcion[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSubscripcions(): void {
    this.eventSubscriber = this.eventManager.subscribe('subscripcionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISubscripcion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
