...
export class EtiquetaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.etiquetaService
      ...
      .subscribe(
        (res: HttpResponse<IEtiqueta[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEtiquetas(): void {
    this.eventSubscriber = this.eventManager.subscribe('etiquetaListModification', () => this.loadPage());
  }
