...
import { MonedaComponent } from 'app/entities/moneda/moneda.component';
  ...
  describe('Moneda Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MonedaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.monedas && comp.monedas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
